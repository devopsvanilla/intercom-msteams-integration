...
class AzureConfig(BaseSettings):
    ...
    redirect_uri: str = Field(default="http://localhost:8000/auth/callback", env="AZURE_REDIRECT_URI")
...
class AppConfig(BaseSettings):
    ...
    default_channel_name: str = Field(default="Customer Support", env="DEFAULT_CHANNEL_NAME")
