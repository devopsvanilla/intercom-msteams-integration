...
class WebhookHandler:
    ...
    async def _handle_conversation_created(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
...
"""
            ...
            if config.default_team_id:
                ...
                logger.info(f"Sent new conversation notification to Teams for {conversation_id}")
    ...
    async def _handle_conversation_reply(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            async with self.intercom_client as client:
                ...
                fin_response = await client.trigger_fin_ai_response(conversation_id, message_body)
...
"""
    ...
    async def _handle_conversation_assigned(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
